<div class="admin-sidebar h-auto text-white flex flex-col p-4 top-0 left-0 w-64" style="background-image: linear-gradient(to right, black, #262422)">
    <div class="mb-8">
        <a href="{{ route('admin.dashboard') }}"><img src="{{ asset('assets/logo.png') }}" alt="LOGO CINEMAXPERIENCE" class="w-32 mx-auto transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-lg"></a>
    </div>
